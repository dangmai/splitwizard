      ...
      {people.map((person, index) => (
        <div key={index} className="person">
          <div className="form-horizontal">
            <TextInputControl
              field={person.name} label="Name" uniqueKey={index}
              controlClassName="col-md-12" labelClassName="col-md-2"
              inputClassName="col-md-10" showHelpBlock
            />
            <DateInputControl
              field={person.moveInDate} label="Move In" uniqueKey={index}
              controlClassName="col-md-6" labelClassName="col-md-4"
              inputClassName="col-md-8" showHelpBlock={false}
            />
            <DateInputControl
              field={person.moveOutDate} label="Move Out" uniqueKey={index}
              controlClassName="col-md-6" labelClassName="col-md-4"
              inputClassName="col-md-8" showHelpBlock={false}
            />
            {index !== 0 &&
